...
class Google_Client
{
  ...
  public function executeTung(RequestInterface $request, $expectedClass = null)
  {
    $request = $request->withHeader(
        'User-Agent',
        $this->config['application_name']
    ...
    return Google_Http_REST::executeTung($http, $request, $expectedClass, $this->config['retry']);
  }
  /**
